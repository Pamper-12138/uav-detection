...
def test_all_model_yamls():
    """Test YOLO model creation for all available YAML configurations in the `cfg/yolo_models` directory."""
    for m in (ROOT / "cfg" / "yolo_models").rglob("*.yaml"):
        if "rtdetr" in m.name:
...
def test_data_annotator():
    """Automatically annotate data using specified detection and segmentation yolo_models."""
...
def test_yolo_world():
    """Tests YOLO world yolo_models with CLIP support, including detection and training scenarios."""
