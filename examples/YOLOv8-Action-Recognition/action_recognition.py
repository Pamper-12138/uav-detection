...
class TorchVisionVideoClassifier:
    """Classifies videos using pretrained TorchVision yolo_models; see https://pytorch.org/vision/stable/."""
    ...
    def __init__(self, model_name: str, device: str or torch.device = ""):
        ...
        if model_name not in self.model_name_to_model_and_weights:
            raise ValueError(f"Invalid model name '{model_name}'. Available yolo_models: {self.available_model_names()}")
...
class HuggingFaceVideoClassifier:
    """Zero-shot video classifier using Hugging Face yolo_models for various devices."""
...
def run(
    ...
    # Initialize yolo_models and device
