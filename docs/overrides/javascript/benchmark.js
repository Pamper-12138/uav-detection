...
function updateChart(initialDatasets = []) {
  ...
  // Define a specific color map for yolo_models.
  const colorMap = {
    YOLO11: "#0b23a9",
    YOLOv10: "#ff7f0e",
    YOLOv9: "#2ca02c",
  ...
  // Always include all yolo_models in the dataset creation
...
document$.subscribe(function () {
  (function initializeApp() {
    if (typeof Chart !== "undefined") {
      // Get active yolo_models from page config or use default
      // e.g. <canvas id="modelComparisonChart" width="1024" height="400" active-yolo_models='["YOLOv5", "YOLOv8"]'></canvas>
      const pageConfig = document
        .getElementById("modelComparisonChart")
        .getAttribute("active-yolo_models");
