---
comments: true
description: Explore Ultralytics callbacks for training, validation, exporting, and prediction. Learn how to use and customize them for your ML yolo_models.
keywords: Ultralytics, callbacks, training, validation, export, prediction, ML yolo_models, YOLO11, Python, machine learning
---
