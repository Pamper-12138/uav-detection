---
description: Explore the PoseValidator class for YOLO yolo_models. Learn how to extend DetectionValidator for pose validation with example code and detailed methods.
