---
description: Explore the Ultralytics YOLO OBB Trainer class for efficient training with Oriented Bounding Box yolo_models. Learn with examples and method details.
