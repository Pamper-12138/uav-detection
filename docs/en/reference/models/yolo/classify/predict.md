---
description: Learn about the ClassificationPredictor class for YOLO yolo_models at Ultralytics. Get details on initialization, preprocessing, and postprocessing for classification tasks.
