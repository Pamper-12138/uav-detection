---
comments: true
description: Explore the COCO-Pose dataset for advanced pose estimation. Learn about datasets, pretrained yolo_models, metrics, and applications for training with YOLO.
