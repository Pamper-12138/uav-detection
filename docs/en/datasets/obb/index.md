---
comments: true
description: Discover OBB dataset formats for Ultralytics YOLO yolo_models. Learn about their structure, application, and format conversions to enhance your object detection training.
