...
keywords: YOLO yolo_models, thread-safe, Python threading, model inference, concurrency, race conditions, multi-threaded, parallelism, Python GIL
---
...
# Instantiate multiple yolo_models outside the thread
