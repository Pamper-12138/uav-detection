...
keywords: RT-DETR, Baidu, Vision Transformer, real-time object detection, PaddlePaddle, Ultralytics, pre-trained yolo_models, AI, machine learning, computer vision
---
