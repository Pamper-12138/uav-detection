...
def classify_transforms(
    ...
    for classification yolo_models during evaluation or inference. The transforms include resizing,
...
def classify_augmentations(
    ...
    This function generates a set of image transformations suitable for training classification yolo_models. It includes
