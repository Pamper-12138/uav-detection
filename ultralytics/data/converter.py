...
def convert_coco(
    ...
    """
    Converts COCO dataset annotations to a YOLO annotation format  suitable for training YOLO yolo_models.
...
def yolo_bbox2segment(im_dir, save_dir=None, sam_model="sam_b.pt", device=None):
    ...
    Args:
        ...
        device (int | str): The specific device to run SAM yolo_models. Default: None.
