...
class Model(torch.nn.Module):
    """
    A base class for implementing YOLO yolo_models, unifying APIs across different model types.

    This class provides a common interface for various operations related to YOLO yolo_models, such as training,
    validation, prediction, exporting, and benchmarking. It handles different types of yolo_models, including those
    ...
    def __init__(
        ...
        model sources, including local files, Ultralytics HUB yolo_models, and Triton Server yolo_models. The method
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        return model.startswith(f"{HUB_WEB_ROOT}/yolo_models/")
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        This method handles loading yolo_models from either .pt checkpoint files or other weight file formats. It sets
    ...
    def _check_is_pytorch_model(self) -> None:
        ...
        if not (pt_module or pt_str):
            raise TypeError(
                ...
                f"PyTorch yolo_models can train, valid, predict and export, i.e. 'model.train(data=...)', but exported "
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        Notes:
            ...
            - For SAM-type yolo_models, 'prompts' can be passed as a keyword argument.
        """
        if source is None:
            source = ASSETS
        ...
        prompts = args.pop("prompts", None)  # for SAM-type yolo_models
        ...
        if prompts and hasattr(self.predictor, "set_prompts"):  # for SAM-type yolo_models
    ...
    def device(self) -> torch.device:
        ...
        applicable only to yolo_models that are instances of torch.nn.Module.
