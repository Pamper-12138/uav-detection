...
class MemoryEncoder(nn.Module):
    ...
    suitable for downstream tasks in image segmentation yolo_models like SAM (Segment Anything Model).
...
class FpnNeck(nn.Module):
    """
    A Feature Pyramid Network (FPN) neck variant for multiscale feature fusion in object detection yolo_models.
